"""PHI redaction helpers (canonical copy — see docs/phi-logging-policy.md).

Copy-pasted into consuming services per ADR 0001 (no shared Python lib).
Copies are parity-tested in tests/test_redaction.py — keep them in sync.
