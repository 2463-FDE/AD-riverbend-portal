...
Optional next step: once a plan brief exists, offer the `spec-lens` skill — perspective review of the brief against the project record (auth boundary, runbook/port/migration policy, ADRs) before branching. Optional, never mandatory.
