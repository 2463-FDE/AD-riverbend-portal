...
- [ ] TODO-1 | Intake contract break: portal payload 422s at intake-service, gateway relays 200, UI reports success; no patient row created | tags: live-defect | blocked_by: G0 | src: docs/specs/frontend-rebuild.md §8 #1 and §8.1
...
- [ ] TODO-7 | Frontend test harness — its own PR and ADR. vitest+RTL shape is contingent on the framework choice | blocked_by: G1 | src: docs/specs/frontend-rebuild.md §4 deliverable 3
